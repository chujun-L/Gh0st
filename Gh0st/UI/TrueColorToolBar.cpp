...
BEGIN_MESSAGE_MAP(CTrueColorToolBar, CToolBar)
	ON_NOTIFY_REFLECT((WORD)TBN_DROPDOWN, OnToolbarDropDown)
END_MESSAGE_MAP()


// CTrueColorToolBar message handlers
BOOL CTrueColorToolBar::LoadTrueColorToolBar(int nBtnWidth, UINT uToolBar, 
											UINT uToolBarHot, UINT uToolBarDisabled)
{
